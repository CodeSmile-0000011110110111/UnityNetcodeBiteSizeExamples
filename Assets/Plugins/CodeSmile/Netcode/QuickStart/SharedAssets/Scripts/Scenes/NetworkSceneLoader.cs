...
{
	/// <summary>
	/// Handles scene loading on events (spawn, despawn), on demand and additive scenes.
	/// </summary>
	public class NetworkSceneLoader : NetworkBehaviour
	{
		...
		private void Awake() => _networkDisconnectManager = FindObjectOfType<NetworkDisconnectManager>();
		...
		private void AddNetworkCallbacks()
		{
			if (NetworkManager?.SceneManager != null)
			{
				...
				_networkDisconnectManager.OnNetworkShutdown += OnNetworkShutdown;
			}
		}
