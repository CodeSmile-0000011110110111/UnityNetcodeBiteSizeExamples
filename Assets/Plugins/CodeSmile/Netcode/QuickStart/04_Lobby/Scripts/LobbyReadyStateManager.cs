...
{
	/// <summary>
	/// Handles the ready-state of connected players in the lobby and changing visuals accordingly.
	/// </summary>
	[DisallowMultipleComponent]
	[RequireComponent(typeof(LobbySpawnManager))]
	public sealed class LobbyReadyStateManager : NetworkBehaviour
	{
		...
		private LobbySpawnManager _spawnManager;

		private void Awake()
		{
			_spawnManager = GetComponent<LobbySpawnManager>();
		...
		{
			var lobbyIndex = _spawnManager.GetClientLobbyIndex(clientId);
